...
| `d$means()`              | return new dictionary with means for each value |
| `d$inplace_means()`      | convert values to means for this dictionary |
| `d$keys()`               | list of keys |
| `d$values()`             | list of values |
| `d$items()`              | list of items (as a list of lists) |
| `d$length()`             | number of items |
...
You can extract the means into a new dictionary:
